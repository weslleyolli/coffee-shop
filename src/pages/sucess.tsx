...
export default function Sucess() {
    ...
    return (
        <div className="px-40 h-screen w-full">
            <Header />
            <main className="py-20 px-5 flex flex-col gap-10">
                <div className="flex flex-col gap-1">
                    <h1 className="text-yellowdark font-baloo font-extrabold text-4xl">Huh! confirmed order</h1>
                    <h2 className="text-baseSubtitle text-xl">Now just wait for the coffee to come to you soon</h2>
                </div>

                <div>
                    <div className="flex justify-between items-center w-full">
                        <div className="w-2/5 flex flex-col gap-8 p-10 border border-purpleMedium rounded-tl-md rounded-tr-[36px] rounded-br-md rounded-bl-[36px]">
